...
export const ROUTE_NAMES = {
  ...
  fourthPage: SITE_PREFIX + "/fourth-page",
  fifthpage: SITE_PREFIX + "/fifth-page",
  sixthPage: SITE_PREFIX + "/sixth-page",
  seventhPage: SITE_PREFIX + "/seventh-page",
  eighthPage: SITE_PREFIX + "/eighth-page",
  ninthPage: SITE_PREFIX + "/ninth-page",
  tenthPage: SITE_PREFIX + "/tenth-page",
  eleventhPage: SITE_PREFIX + "/eleventh-page",
  twelvethPage: SITE_PREFIX + "/twelvethPage",
  thirteenthPage: SITE_PREFIX + "/thirteenth-page",
  fourteenthPage: SITE_PREFIX + "/fourteenth-page",
  journeyStart: SITE_PREFIX + "/journey-start",
  excitedForFood0: SITE_PREFIX + "/excited-for-food-0",
  excitedForFood: SITE_PREFIX + "/excited-for-food",
  excitedForFood2: SITE_PREFIX + "/excited-for-food-2",
  excitedForFood3: SITE_PREFIX + "/excited-for-food-3",
  excitedForFood4: SITE_PREFIX + "/excited-for-food-4",
  excitedForFood4Dash5: SITE_PREFIX + "/excited-for-food-4.5",
  excitedForFood5: SITE_PREFIX + "/excited-for-food-5",
  excitedForFood6: SITE_PREFIX + "/excited-for-food-6",
  excitedForFood7: SITE_PREFIX + "/excited-for-food-7",
  excitedForFood8: SITE_PREFIX + "/excited-for-food-8",
  sleep1: SITE_PREFIX + "/sleep-1",
  sleep2: SITE_PREFIX + "/sleep-2",
  sleep3: SITE_PREFIX + "/sleep-3",
  sleep4: SITE_PREFIX + "/sleep-4",
  sleep5: SITE_PREFIX + "/sleep-5",
  sleep6: SITE_PREFIX + "/sleep-6",
  sleep7: SITE_PREFIX + "/sleep-7",
  woaStart: SITE_PREFIX + "/woa-start",
  woa1: SITE_PREFIX + "/woa-1",
  woa2: SITE_PREFIX + "/woa-2",
  woa3: SITE_PREFIX + "/woa-3",
  woa3Dash5: SITE_PREFIX + "/woa-3.5",
  woa4: SITE_PREFIX + "/woa-4",
  woa5: SITE_PREFIX + "/woa-5",
  woa6: SITE_PREFIX + "/woa-6",
  woa7: SITE_PREFIX + "/woa-7",
  woa8: SITE_PREFIX + "/woa-8",
  woa8Dash5: SITE_PREFIX + "/woa-8.5",
  woa9: SITE_PREFIX + "/woa-9",
  woa10: SITE_PREFIX + "/woa-10",
  woa11: SITE_PREFIX + "/woa-11",
  woa12: SITE_PREFIX + "/woa-12",
  woa13: SITE_PREFIX + "/woa-13",
  woa14: SITE_PREFIX + "/woa-14",
  woa15: SITE_PREFIX + "/woa-15",
  woa16: SITE_PREFIX + "/woa-16",
  woaFriends: SITE_PREFIX + "/woa-friends",
  eatTooMuch: SITE_PREFIX + "/eat-too-much",
  accessDenied: SITE_PREFIX + "/access-denied",
  notFound: SITE_PREFIX + "/not-found",
  todo: SITE_PREFIX + "/todo",
};
